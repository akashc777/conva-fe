...
import {isInStandaloneMode} from "../../utils/Helper.ts";
...
const MessageInput: React.FC<MessageInputProp> = ({Type, UniqueId, HandleSendMessage, PublishTypingWithThrottle}) => {
  ...
  <div ref={mentionRef}
       className="flex pb-4 justify-center md:block shadow-inner message-input bg-gray-200 rounded-lg p-2 pl-2 pr-2 relative">
