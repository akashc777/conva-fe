...
import {updateLastSeenDmId} from "../../store/slice/dmSlice.ts";
...
const ChatPage: React.FC = () => {
  ...
  const dmPersistModule=useSelector((state:RootState)=>state.dm)
  ...
  useEffect(() => {
    ...
    if(dmId == undefined && dmPersistModule.lastSelectedDm){
      handleDmListOnClick(dmPersistModule.lastSelectedDm)
    }
